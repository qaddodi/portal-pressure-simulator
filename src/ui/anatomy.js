...
export const EDGE_PATH = {
  ...
  V_STO: 'M880 395 C 862 372 834 336 803 318',
  SMV_CONF: 'M690 660 C 692 625 696 590 700 556',
  SV_CONF: 'M880 505 C 830 525 765 545 700 556',
  LGV_CONF: 'M803 318 C 809 346 812 380 810 408 C 808 434 797 452 779 463 C 758 475 734 474 717 480 C 703 490 700 524 700 556',
  ...
  C1a: 'M803 318 C 800 298 803 280 800 262 C 798 250 797 240 797 232',
  ...
  C2b: 'M876 302 C 854 298 826 304 803 318',
