...
export const EDGE_PATH = {
  ...
  V_STO: 'M880 395 C 862 372 838 342 812 322',
  SMV_CONF: 'M690 660 C 692 625 696 590 700 556',
  SV_CONF: 'M880 505 C 830 525 765 545 700 556',
  LGV_CONF: 'M812 322 C 817 346 820 380 818 410 C 816 440 806 462 786 474 C 764 486 738 484 722 490 C 708 500 702 526 700 556',
  ...
  C1a: 'M812 322 C 808 300 803 280 800 262 C 798 250 797 240 797 232',
  ...
  C2b: 'M876 302 C 856 300 830 308 812 322',
