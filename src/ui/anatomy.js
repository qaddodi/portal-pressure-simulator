...
export const EDGE_PATH = {
  ...
  V_STO: 'M880 395 C 862 405 840 418 814 428',
  SMV_CONF: 'M690 660 C 692 625 696 590 700 556',
  SV_CONF: 'M880 505 C 830 525 765 545 700 556',
  LGV_CONF: 'M814 428 C 810 448 800 464 784 474 C 762 486 736 484 722 490 C 708 500 702 526 700 556',
  ...
  C1a: 'M814 428 C 821 404 822 372 818 342 C 815 320 811 302 806 286 C 801 268 798 250 797 232',
  ...
  C2b: 'M876 302 C 877 342 900 382 880 395 C 862 405 840 418 814 428',
