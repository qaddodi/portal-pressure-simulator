...
import { createStage } from './stage.js?v=80502f6fb0';
import { createInspector } from './inspector.js?v=718cafd0b0';
import { createDock } from './dock.js?v=a681541ca1';
...
import { createChart } from './chart.js?v=77f6831e3f';
...
async function main() {
  ...
  paletteL = lazy(() => import('./palette.js?v=02b76f6a31'), ({ createPalette }) => createPalette({ ctx: {
