...
import { createStage } from './stage.js?v=7efe7583a3';
import { createInspector } from './inspector.js?v=718cafd0b0';
import { createDock } from './dock.js?v=ae3c869d40';
...
import { createChart } from './chart.js?v=e4e679e018';
...
async function main() {
  ...
  paletteL = lazy(() => import('./palette.js?v=91da8eb29d'), ({ createPalette }) => createPalette({ ctx: {
