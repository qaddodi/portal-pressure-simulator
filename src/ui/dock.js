...
import { createProfile, createScope, createSankey, createPerfusion } from './charts.js?v=66af0f81e0';
import { createHVPG, createDoppler, createEndoscopy, createLobule, createVarixWall, createAbdomen } from './instruments.js?v=3a9ebac16a';
